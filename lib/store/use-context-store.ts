  ...
  addInterest: async (interest) => {
    ...
    try {
      const response = await fetch('/api/context', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ type: 'interest', data: { interest } }),
      });
  ...
  addGoal: async (goal) => {
    ...
    try {
      const response = await fetch('/api/context', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ type: 'goal', data: { goal, completed: false } }),
      });
  ...
  addTrait: async (trait) => {
    ...
    try {
      const response = await fetch('/api/context', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ type: 'trait', data: { trait } }),
      });
  ...
  addConnection: async (connection) => {
    ...
    try {
      const response = await fetch('/api/context', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ type: 'connection', data: connection }),
      });
